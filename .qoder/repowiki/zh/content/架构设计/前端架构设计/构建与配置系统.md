...
## 更新摘要
**变更内容**
- 移除了原桌面应用根工程中的特殊配置与命令文档
- 简化了 Tauri 集成流程，采用标准的前后端分离模式
- 更新了构建脚本以反映当前配置方式
- 优化了开发工作流说明
...
**更新** 移除了原桌面应用根工程中的特殊配置与命令，现在采用标准的 Tauri 集成方式。
...
**更新** 简化了 Tauri 集成流程，移除了原桌面应用根工程中的特殊配置，采用标准的前后端分离模式。
...
**更新** 由于移除了原桌面应用根工程中的特殊配置，Tauri 相关问题应参考标准 Tauri 文档进行排查。
...
**更新** 当前配置已简化，移除了原桌面应用根工程中的特殊配置，采用更标准的 Tauri 集成方式，提升了项目的可维护性和标准化程度。
...
**更新** 移除了原桌面应用根工程中的特殊配置与命令，现在推荐使用标准的 Tauri 工作流程。
