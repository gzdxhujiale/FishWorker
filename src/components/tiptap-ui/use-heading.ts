...
} from "quill/lib/tiptap-utils"

// --- Icons ---
import { HeadingOneIcon } from "quill/components/tiptap-icons/heading-one-icon"
import { HeadingTwoIcon } from "quill/components/tiptap-icons/heading-two-icon"
import { HeadingThreeIcon } from "quill/components/tiptap-icons/heading-three-icon"
import { HeadingFourIcon } from "quill/components/tiptap-icons/heading-four-icon"
import { HeadingFiveIcon } from "quill/components/tiptap-icons/heading-five-icon"
import { HeadingSixIcon } from "quill/components/tiptap-icons/heading-six-icon"
