...
- [src/features/habits/HabitPanel.tsx:1-40](file://src/features/habits/HabitPanel.tsx#L1-L40)
...
- 功能面板
  - ListsPanel、TimeManagementPanel、DailyReviewPanel、HabitPanel 等分别对应清单、时间管理、每日复盘、习惯追踪等功能域。
- 基础 UI 与编辑器
...
- [src/features/habits/HabitPanel.tsx:1-80](file://src/features/habits/HabitPanel.tsx#L1-L80)
...
### 习惯追踪（Habits）
- HabitPanel 聚合习惯列表、详情侧边栏、编辑弹窗等。
- habitTypes.ts 定义类型约束，components 下细分可复用卡片与表单。

章节来源
- [src/features/habits/HabitPanel.tsx:1-200](file://src/features/habits/HabitPanel.tsx#L1-L200)
- [src/features/habits/habitTypes.ts:1-120](file://src/features/habits/habitTypes.ts#L1-L120)
- [src/features/habits/components/HabitCard.tsx:1-120](file://src/features/habits/components/HabitCard.tsx#L1-L120)
- [src/features/habits/components/HabitDetailSidebar.tsx:1-120](file://src/features/habits/components/HabitDetailSidebar.tsx#L1-L120)
- [src/features/habits/components/HabitEditModal.tsx:1-120](file://src/features/habits/components/HabitEditModal.tsx#L1-L120)
...
- [src/components/tiptap-ui-primitive/button.tsx:1-80](file://src/components/tiptap-ui-primitive/button.tsx#L1-L80)
- [src/components/tiptap-ui-primitive/dropdown-menu.tsx:1-80](file://src/components/tiptap-ui-primitive/dropdown-menu.tsx#L1-L80)
- [src/components/tiptap-ui-primitive/popover.tsx:1-80](file://src/components/tiptap-ui-primitive/popover.tsx#L1-L80)
...
## 结论
FishWorker 前端采用清晰的功能域分层与原子组件体系，配合轻量状态管理与编辑器能力封装，具备良好的可扩展性与可维护性。后续可在路由抽象、国际化、主题系统完善与更细粒度的性能监控方面持续演进。
...
- [src/styles/layout.css:1-120](file://src/styles/layout.css#L1-L120)
...
- [package.json:1-120](file://package.json#L1-L120)
- [pnpm-workspace.yaml:1-40](file://pnpm-workspace.yaml#L1-L40)
